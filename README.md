...
**On the staging environment, the EKS nodes are private and are accessible only via bastion tunnel -note that you need to pass the key name to connect to the bastion-**
```
